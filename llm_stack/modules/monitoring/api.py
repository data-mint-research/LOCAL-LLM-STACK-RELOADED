"""
Standardisierte API-Schnittstelle für das Monitoring-Modul.

Dieses Modul stellt eine standardisierte API-Schnittstelle für das Monitoring-Modul bereit.
"""
...
from llm_stack.modules.monitoring import (
    MODULE_API_VERSION,
    MODULE_NAME,
    MODULE_STATUS_ERROR,
